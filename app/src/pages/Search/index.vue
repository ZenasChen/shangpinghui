      ...
      <div class="py-container">
        ...
        <div class="details clearfix">
            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder('1')">
                  <a>综合<span v-show="isOne" class="iconfont" :class="{'icon-Arrow-up':isAsc,'icon-Arrow-down':isDesc}"></span></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder('2')">
                  <a>价格<span v-show="isTwo" class="iconfont" :class="{'icon-Arrow-up':isAsc,'icon-Arrow-down':isDesc}"></span></a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              <li class="yui3-u-1-5">
                <div class="list-wrap" v-for="(good,index) in goodsList" :key="good.id">
                  <div class="p-img">
